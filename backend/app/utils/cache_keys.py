...
BANGUMI_SEARCH_TTL = MEDIUM_CACHE_TTL  # 搜索结果 30 分钟
BANGUMI_SUBJECT_DETAIL_TTL = VERY_LONG_CACHE_TTL  # 条目详情 24 小时
BANGUMI_CALENDAR_TTL = LONG_CACHE_TTL  # 每日放送 1 小时
